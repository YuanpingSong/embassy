...
Do not report conduct incidents through a public issue or through the security
vulnerability channel.

**Required before public release:** the maintainer must replace this paragraph
with a working private conduct-reporting method. No private conduct channel is
configured yet, and this repository must not be made public until one is
documented here.

Once configured, all complaints will be reviewed and investigated promptly
and fairly.
