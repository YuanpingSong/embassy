...
export const dashboardCopyKeys = [
  ...
  "guidance.providerIncompatible.title",
  ...
  "watches.reason.legacyUpgrade",
  "watches.reason.legacyDone",
  "activity.eyebrow",
  "activity.title",
  "activity.note",
  "activity.empty",
  ...
  "diagnostics.version",
  "diagnostics.testedVersion",
  "diagnostics.supportedMajor",
  "diagnostics.tier",
  ...
  "app.diag.col.compat",
  "app.diag.providerCompatibility.title",
