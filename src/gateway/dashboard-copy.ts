...
export const dashboardCopyKeys = [
  ...
  "guidance.codexAppReconnectRequired.title",
  ...
  "guidance.registryRejected.title",
  ...
  "watches.event.replaced",
  "watches.event.settled",
  "watches.actor.owner",
  "watches.actor.worker",
  "watches.actor.operator",
  "watches.actor.gateway",
  "watches.actor.unknown",
  "watches.reason.done",
  "watches.reason.untracked",
  "watches.reason.idleTimeout",
  "watches.reason.pairRemoved",
  "watches.reason.endpointRetired",
  "watches.reason.trackingDisabled",
  "activity.eyebrow",
  "activity.title",
  "activity.note",
  "activity.empty",
  ...
  "diagnostics.registry.rejected",
  "diagnostics.registry.rejectedNone",
  ...
  "diagnostics.omissions.consentEdges",
  ...
  "app.deliveries.fromProvider",
  "app.deliveries.toProvider",
  "app.deliveries.providerAll",
  ...
  "app.routes.unpairedProvider",
  "app.routes.consentEndpoint",
  "app.routes.consentEdge",
