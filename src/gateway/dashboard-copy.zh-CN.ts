...
export const dashboardCopyZhCn = {
  ...
  "app.deliveries.dir.all": "全部方向",
  "app.deliveries.view.byRoute": "按路由对",
  "app.deliveries.view.flat": "平铺",
  "app.deliveries.state.all": "全部状态",
  "app.deliveries.search": "按后缀、别名或安全代码筛选",
  "app.deliveries.noMatch": "没有符合此筛选条件的投递。",
  "app.deliveries.pickRow": "选择一条投递以查看其生命周期。",
  "app.deliveries.lifecycle": "生命周期",
  "app.deliveries.frames": "证据帧",
  "app.deliveries.noFrames": "此投递没有记录任何安全代码。",
  "app.deliveries.raw": "显示原始 JSON",
